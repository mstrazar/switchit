...
c[rindex] = cmv*cmv_ar*1.0/ta_factor;  rindex++;

reactants[rindex][P0_TALA_VP16_VP16] = 1; products[rindex][P0_TALA_VP16_VP16] = 1;
products[rindex][TALB_KRAB] = 1; products[rindex][BFP] = 1;
c[rindex] = cmv*cmv_a*ta_factor;  rindex++;
...
products[rindex][TALB_KRAB] = 1; products[rindex][BFP] = 1;
c[rindex] = cmv*cmv_leak*1.0/ta_factor;  rindex++;
...
reactants[rindex][P1_TALA_KRAB_KRAB] = 1; products[rindex][P1_TALA_KRAB_KRAB] = 1;
products[rindex][TALA_VP16] = 1;
c[rindex] = cmv*cmv_leak*1.0/ta_factor;  rindex++;
...
c[rindex] = cmv*cmv_ar*1.0/tb_factor;  rindex++;

reactants[rindex][P2_TALB_VP16_VP16] = 1; products[rindex][P2_TALB_VP16_VP16] = 1;
products[rindex][TALA_KRAB] = 1; products[rindex][mCITRINE] = 1;
c[rindex] = cmv*cmv_a*tb_factor;  rindex++;
...
products[rindex][TALA_KRAB] = 1; products[rindex][mCITRINE] = 1;
c[rindex] = cmv*cmv_leak*1.0/tb_factor;  rindex++;
...
reactants[rindex][P3_TALB_KRAB_KRAB] = 1; products[rindex][P3_TALB_KRAB_KRAB] = 1;
products[rindex][TALB_VP16] = 1;
c[rindex] = cmv*cmv_leak*1.0/tb_factor;  rindex++;
...
reactants[rindex][P5] = 2;
products[rindex][P5] = 2; products[rindex][TALA_VP16] = 2;
c[rindex] = cta*p_leak_pir;  rindex++;
...
reactants[rindex][P7] = 2;
products[rindex][P7] = 2; products[rindex][TALB_VP16] = 2;
c[rindex] = cta*p_leak_etr;  rindex++;
...
if(argc == 1){
    ...
    int rr;
    FILE * fw;
    fw = fopen("weights_cmvfeed.h", "w");
    for(ii=0; ii<REACTIONS; ii++){
        //printf("w[%d] = c[%d] ",ii,ii,ii);
